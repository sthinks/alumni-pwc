...
@section("title", sprintf("%s - Galeri", $media->media_title))
@section("content")
    <div class="card mb-5 mb-xl-8 mt-5">
        <!--begin::Header-->
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{ $media->media_title }} - Galeri</span>
            </h3>
            <div class="card-toolbar">
                <a href="{{ route('manager.medias.gallery.create', $media->id) }}" class="btn btn-sm btn-light-primary">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <form style="display: contents"
                                      action="{{ route("manager.medias.gallery.destroy", [$media->id, $file->id]) }}" method="post">
                                    @csrf
                                    @method("delete")
