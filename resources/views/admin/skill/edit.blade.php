    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form class="form" method="post" action="{{ route('manager.skills.update', $item->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    <div class="card-body">
                        <div class="mb-10">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <button type="submit" class="btn btn-success mr-2">Yetenek Düzenle</button>
