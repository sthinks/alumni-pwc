                ...
                <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 pwc-card_login">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" id="forget_pw_form">
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Input-->
                            <input style="border:2px solid #e2e2e2;" placeholder="E-mail" value="{{ old('email') }}" class="form-control form-control-lg @error('email') is-invalid @enderror" type="text" name="email" autocomplete="off" required />
                            @error('email')
