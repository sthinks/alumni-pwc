...
<head>
    ...
    <title>{{ $event->event_title }} etkinliği iptal edilmiştir | PwC Alumni</title>
                                ...
                                <td align="center" valign="top" style="background:#FFF;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="top"><table width="85" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td height="85" align="center" valign="middle" style="border-bottom:4px solid #7d7d7d"><img mc:edit="tm2-02" editable="true" src="https://www.pwc.com.tr/tr/mail/assets/etkinlik-iptal-icon-2.png" width="50" height="50" alt="" /></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#ff0000; line-height:22px; font-weight:normal;"><div class="external-button">etkinliğimiz ileri bir tarihe ertelenmiştir.</div></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:13px; color:#71746f; line-height:22px; font-weight:normal;">Etkinlik hakkında ayrıca size bilgilendirme yapılacaktır.</td>
                                        </tr>
                                        <tr>
