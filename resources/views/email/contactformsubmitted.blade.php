...
<head>
    ...
    <title>Yeni İletişim Formu | PwC Alumni</title>
                    ...
                    <td align="center" valign="top"><table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left-inner">
                            <tr>
                                <td align="center" valign="top" style="background:#FFF;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="top" class="btn-card">
                                                <!-- Button Table // -->
                                                <table class="tg">
                                                    <tr>
                                                        <th class="tg-cqfb"><span style="font-weight:bold">Ad soyad</span></th>
                                                        <td class="tg-g8np" style="text-align:center">{{ $user['name'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="tg-cqfb"><span style="font-weight:bold">Telefon</span></th>
                                                        <td class="tg-g8np" style="text-align:center">{{ $user['phone'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="tg-cqfb"><span style="font-weight:bold">Başlık</span></th>
                                                        <td class="tg-g8np" style="text-align:center">{{ $contact['contact_title'] }}</td>

                                                    </tr>
                                                    <tr>
                                                        <th class="tg-cqfb"><span style="font-weight:bold">Açıklama</span></th>
                                                        <td class="tg-g8np" style="text-align:center">{{ $contact['contact_message'] }}</td>
                                                    </tr>
                                                    <tr></tr>
                                                </table>
                                            </td>
