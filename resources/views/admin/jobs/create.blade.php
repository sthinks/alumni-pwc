        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">İş İlanı Ekle</h3>
                </div>
                <form class="form" method="post" action="{{ route('manager.jobs.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="mb-10">
                            <label for="exampleFormControlInput1" class="required form-label">Şirket Adı</label>
                            <input value="{{ old("job_company") }}" name="job_company" type="text" class="form-control form-control-solid" required/>
                        </div>
                        <div class="row mb-10">
                            <!--begin::Label-->
                            ...
                            <div class="col-lg-9 d-flex align-items-center">
                                <div class="form-check form-check-solid form-switch fv-row">
                                    <input name="job_company_visible" class="form-check-input w-45px h-30px"
                                           type="checkbox" id="job_company_visible_id" checked />
                        ...
                        <div class="mb-10">
                            ...
                            <input value="{{ old("job_title") }}" name="job_title" type="text" class="form-control form-control-solid" required/>
                        </div>
                        <div class="mb-10">
                            <label for="exampleFormControlInput1" class="required form-label">Pozisyon Adı</label>
                            <input value="{{ old("job_position") }}" name="job_position" type="text" class="form-control form-control-solid" required/>
                        </div>
                        <div class="mb-10">
                            <label for="exampleFormControlInput1" class="required form-label">Pozisyon Seviyesi</label>
                            <input value="{{ old("job_position_level") }}" name="job_position_level" type="text" class="form-control form-control-solid" required/>
                        </div>
                        <div class="mb-10">
                            ...
                            <select id="job_location" name="job_location" class="form-select" data-control="select2" data-placeholder="Select an option">
                                @foreach($cities as $city)
                                    <option value="{{ $city->id }}" @if(old('job_location') === $city->id)) selected @endif>{{ $city->city }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-10">
                            ...
                            <select id="job_owner_id" name="job_owner_id" class="form-select" data-control="select2" data-placeholder="Select an option">
                                <option value="" selected disabled hidden>Seçim yapınız</option>
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" @if(old('job_owner_id') === $user->id)) selected @endif>{{ $user->name }}</option>
                                    @endforeach
                            </select>
                        </div>
                        <div class="mb-10">
                            <label for="exampleFormControlInput1" class="required form-label">Deneyim (yıl)</label>
                            <input value="{{ old("job_experience") }}" name="job_experience" type="number" class="form-control form-control-solid" required/>
                        </div>
                        <div class="mb-10">
                            <label for="exampleFormControlInput1" class="required form-label">İlan Başvuru Linki</label>
                            <input value="{{ old("job_apply_link") }}" name="job_apply_link" type="text" class="form-control form-control-solid" required/>
                        </div>
                        <div class="mb-10">
                            <label for="job_abstract" class="form-label">İlan Kısa Açıklaması</label>
                            <textarea id="job_abstract" name="job_abstract" class="form-control form-control-solid">{{ old("job_abstract") }}</textarea>
                        </div>
                        <div class="mb-10">
                            <label for="job_description" class="required form-label">İlan Açıklaması</label>
                            <textarea id="job_description" name="job_description" class="form-control form-control-solid">{{ old("job_description") }}</textarea>
                        </div>
                        <div class="row mb-10">
                            <!--begin::Label-->
                            ...
                            <div class="col-lg-9 d-flex align-items-center">
                                <div class="form-check form-check-solid form-switch fv-row">
                                    <input name="job_visible" class="form-check-input w-45px h-30px"
                                           type="checkbox" id="job_visible_id"/>
                        ...
                        <div class="mb-10">
                            ...
                            <input name="job_valid_till" type="datetime-local" class="form-control form-control-solid" required/>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <button type="submit" class="btn btn-success mr-2">İlanı Ekle</button>
