...
<head>
    ...
    <title>Üyeliğiniz Onaylandı | PwC Alumni</title>
                                ...
                                <td align="center" valign="top" style="background:#FFF;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="top"><table width="85" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td height="85" align="center" valign="middle" style="border-bottom:4px solid #7d7d7d"><img mc:edit="tm2-02" editable="true" src="https://www.pwc.com.tr/tr/mail/assets/uyelik-onay-icon-2.png" width="50" height="50" alt="" /></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="font-family:Open Sans,sans-serif,Verdana;font-size:16px;color:#71746f;line-height:22px;font-weight:normal"><div class="external-button"><b>Üyeliğiniz Onaylandı.</b><br><br>
                                            Profilinizi güncellemek için web sayfamızı ziyaret edebilirsiniz.</div></td>
                                        </tr>
                                        <tr>
                                            <td align="center" valign="top"><table width="180" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td height="60" align="center" valign="middle" style="background:#d04a02; -moz-border-radius: 10px; border-radius: 10px; font-family:'Open Sans', Verdana, Arial; font-size:14px; font-weight:bold; color:#FFF; "><a class="external-button" href="{{ route('profile.index') }}" style="text-decoration:none; color:#FFF;">Profilimi güncelle</a></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr>
