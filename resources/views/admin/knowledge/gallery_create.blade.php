...
@section("title", sprintf("%s - Medya Ekle", $knowledge->knowledge_title))
@section("content")
    <div class="row">
        <div class="col-lg-12">
            <!--begin::Card-->
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">{{ $knowledge->knowledge_title }} - Medya Ekle</h3>
                </div>
                <form class="form" method="post" action="{{ route('manager.knowledge.gallery.store', $knowledge->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="mb-10">
