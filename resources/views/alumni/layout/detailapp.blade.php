            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="padding-left: 0;">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="padding: 0;">
                    ...
                    <div class="position-relative mb-17">
                        <!--begin::Overlay-->
                        <div class="row  web_app_post_text_detail" style="background: #2D2D2D; align-items:center;">
                            <!--begin::Image-->
                            <!--end::Image-->
                            <!--begin::layer-->
                            <div class="col-md-8 col-sm-12">
                                <!--begin::Heading-->
                                <div class="position-relative text-white d-grid">
                                    <!--begin::Title-->
                                    <h1 class="alumni_detail_app_abstract_title fs-4qx fw-bolder">
                                        <span>@yield("title")</span>
                                    </h1>
                                    <h5 class="alumni_detail_app_abstract_text"><span>@yield("abstract")</span></h5>
                                    <!--end::Title-->
                                </div>
                            </div>
                            <div class="col-md-4 detail-app-image"><img src="@yield('bg')" alt="img"
